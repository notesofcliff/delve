"""This test module is meant to test the using command,
located at events.search_commands.qs.using.
"""
import json
...
class UsingTests(APITestCase):
    ...
    def test_using(self):
        """Test the using command to ensure it correctly selects
        the database to use for the QuerySet.
        """
        query = Query(
            name="test",
            text="search index=test | qs_using default",
            user=self.user,
        )
