...
"""This test module is meant to test the delete search
command, located at events.search_commands.qs.delete.
"""
import json
...
class DeleteTests(APITestCase):
    ...
    def test_delete(self):
        """Test the delete command to ensure it correctly deletes
        the records from the QuerySet.
        """
        query = Query(
            name="test",
            text="search index=test | qs_delete",
            user=self.user,
        )
