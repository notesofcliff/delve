...
"""This test module is meant to test the sort search
command, located at events.search_commands.sort.
"""
import json
...
class SortTests(APITestCase):
    ...
    def test_sort(self) -> None:
        """Test the sort command to ensure it correctly sorts
        the result set by the specified fields.
        """
        query = Query(
            name="test",
            text="search index=test | explode extracted_fields | sort foo",
            user=self.user,
        )
