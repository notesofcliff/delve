...
"""This test module is meant to test the run_query search
command, located at events.search_commands.run_query.
"""
import json
...
class RunQueryTests(APITestCase):
    ...
    def test_run_query(self) -> None:
        """Test the run_query command to ensure it correctly runs
        a saved query and returns the results.
        """
        query = Query(
            name="test",
            text="run_query test_query",
            user=self.user,
        )
